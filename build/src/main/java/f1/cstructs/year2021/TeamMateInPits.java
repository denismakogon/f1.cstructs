...
public class TeamMateInPits {
    ...
    ).withName("TeamMateInPits");
    public static MemoryLayout $LAYOUT() {
        return TeamMateInPits.$struct$LAYOUT;
    }
    ...
    public static VarHandle vehicleIdx$VH() {
        return TeamMateInPits.vehicleIdx$VH;
    }
    public static byte vehicleIdx$get(MemorySegment seg) {
        return (byte)TeamMateInPits.vehicleIdx$VH.get(seg);
    }
    public static void vehicleIdx$set( MemorySegment seg, byte x) {
        TeamMateInPits.vehicleIdx$VH.set(seg, x);
    }
    public static byte vehicleIdx$get(MemorySegment seg, long index) {
        return (byte)TeamMateInPits.vehicleIdx$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void vehicleIdx$set(MemorySegment seg, long index, byte x) {
        TeamMateInPits.vehicleIdx$VH.set(seg.asSlice(index*sizeof()), x);
    }
