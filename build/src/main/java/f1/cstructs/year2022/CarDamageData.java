...
public class CarDamageData {
    ...
    static final VarHandle m_ersFault$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("m_ersFault"));
    public static VarHandle m_ersFault$VH() {
        return CarDamageData.m_ersFault$VH;
    }
    public static byte m_ersFault$get(MemorySegment seg) {
        return (byte)CarDamageData.m_ersFault$VH.get(seg);
    }
    public static void m_ersFault$set( MemorySegment seg, byte x) {
        CarDamageData.m_ersFault$VH.set(seg, x);
    }
    public static byte m_ersFault$get(MemorySegment seg, long index) {
        return (byte)CarDamageData.m_ersFault$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void m_ersFault$set(MemorySegment seg, long index, byte x) {
        CarDamageData.m_ersFault$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    static final VarHandle m_engineBlown$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("m_engineBlown"));
    public static VarHandle m_engineBlown$VH() {
        return CarDamageData.m_engineBlown$VH;
    }
    public static byte m_engineBlown$get(MemorySegment seg) {
        return (byte)CarDamageData.m_engineBlown$VH.get(seg);
    }
    public static void m_engineBlown$set( MemorySegment seg, byte x) {
        CarDamageData.m_engineBlown$VH.set(seg, x);
    }
    public static byte m_engineBlown$get(MemorySegment seg, long index) {
        return (byte)CarDamageData.m_engineBlown$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void m_engineBlown$set(MemorySegment seg, long index, byte x) {
        CarDamageData.m_engineBlown$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle m_engineSeized$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("m_engineSeized"));
    public static VarHandle m_engineSeized$VH() {
        return CarDamageData.m_engineSeized$VH;
    }
    public static byte m_engineSeized$get(MemorySegment seg) {
        return (byte)CarDamageData.m_engineSeized$VH.get(seg);
    }
    public static void m_engineSeized$set( MemorySegment seg, byte x) {
        CarDamageData.m_engineSeized$VH.set(seg, x);
    }
    public static byte m_engineSeized$get(MemorySegment seg, long index) {
        return (byte)CarDamageData.m_engineSeized$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void m_engineSeized$set(MemorySegment seg, long index, byte x) {
        CarDamageData.m_engineSeized$VH.set(seg.asSlice(index*sizeof()), x);
    }
