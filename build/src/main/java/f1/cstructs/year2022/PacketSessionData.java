...
public class PacketSessionData {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_CHAR$LAYOUT.withName("m_gameMode"),
        Constants$root.C_CHAR$LAYOUT.withName("m_ruleSet"),
        Constants$root.C_INT$LAYOUT.withName("m_timeOfDay"),
        Constants$root.C_CHAR$LAYOUT.withName("m_sessionLength")
    ...
    static final VarHandle m_gameMode$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("m_gameMode"));
    public static VarHandle m_gameMode$VH() {
        return PacketSessionData.m_gameMode$VH;
    }
    public static byte m_gameMode$get(MemorySegment seg) {
        return (byte)PacketSessionData.m_gameMode$VH.get(seg);
    }
    public static void m_gameMode$set( MemorySegment seg, byte x) {
        PacketSessionData.m_gameMode$VH.set(seg, x);
    }
    public static byte m_gameMode$get(MemorySegment seg, long index) {
        return (byte)PacketSessionData.m_gameMode$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void m_gameMode$set(MemorySegment seg, long index, byte x) {
        PacketSessionData.m_gameMode$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle m_ruleSet$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("m_ruleSet"));
    public static VarHandle m_ruleSet$VH() {
        return PacketSessionData.m_ruleSet$VH;
    }
    public static byte m_ruleSet$get(MemorySegment seg) {
        return (byte)PacketSessionData.m_ruleSet$VH.get(seg);
    }
    public static void m_ruleSet$set( MemorySegment seg, byte x) {
        PacketSessionData.m_ruleSet$VH.set(seg, x);
    }
    public static byte m_ruleSet$get(MemorySegment seg, long index) {
        return (byte)PacketSessionData.m_ruleSet$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void m_ruleSet$set(MemorySegment seg, long index, byte x) {
        PacketSessionData.m_ruleSet$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle m_timeOfDay$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("m_timeOfDay"));
    public static VarHandle m_timeOfDay$VH() {
        return PacketSessionData.m_timeOfDay$VH;
    }
    public static int m_timeOfDay$get(MemorySegment seg) {
        return (int)PacketSessionData.m_timeOfDay$VH.get(seg);
    }
    public static void m_timeOfDay$set( MemorySegment seg, int x) {
        PacketSessionData.m_timeOfDay$VH.set(seg, x);
    }
    public static int m_timeOfDay$get(MemorySegment seg, long index) {
        return (int)PacketSessionData.m_timeOfDay$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void m_timeOfDay$set(MemorySegment seg, long index, int x) {
        PacketSessionData.m_timeOfDay$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle m_sessionLength$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("m_sessionLength"));
    public static VarHandle m_sessionLength$VH() {
        return PacketSessionData.m_sessionLength$VH;
    }
    public static byte m_sessionLength$get(MemorySegment seg) {
        return (byte)PacketSessionData.m_sessionLength$VH.get(seg);
    }
    public static void m_sessionLength$set( MemorySegment seg, byte x) {
        PacketSessionData.m_sessionLength$VH.set(seg, x);
    }
    public static byte m_sessionLength$get(MemorySegment seg, long index) {
        return (byte)PacketSessionData.m_sessionLength$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void m_sessionLength$set(MemorySegment seg, long index, byte x) {
        PacketSessionData.m_sessionLength$VH.set(seg.asSlice(index*sizeof()), x);
    }
